...
public class JdbcVetRepositoryImpl implements VetRepository {
     ...
     */
    /**
     * Loads the {@link org.springframework.samples.petclinic.model.Vet} with the supplied <code>id</code>
     */
    @Override
    public Vet findById(int id) throws DataAccessException {
        ...
        try {
            ...
            vet = this.namedParameterJdbcTemplate.queryForObject(
                    "SELECT id, first_name, last_name, days, email FROM vet WHERE id= :id",
                    params,
                    ParameterizedBeanPropertyRowMapper.newInstance(Vet.class)
            );
